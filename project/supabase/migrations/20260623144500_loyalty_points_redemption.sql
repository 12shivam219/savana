-- Add constraint to prevent negative loyalty points on profiles
ALTER TABLE public.profiles ADD CONSTRAINT check_loyalty_points_non_negative CHECK (loyalty_points >= 0);

-- PostgreSQL function to wrap checkout operations including loyalty point redemption into a single transaction
